<?php 
    if ($lot['last_price'] === null) {
        $lot_price = to_price($lot['first_price']);
    } else {
        $lot_price = to_price($lot['last_price']);
    }
?>
...
<li class="lots__item lot">
    ...
    <div class="lot__info">
        ...
        <h3 class="lot__title"><a class="text-link" href="/?tab=<?=$lot['id']; ?>"><?=esc($lot['name']); ?></a>
        <?=$lot['id']; ?></h3>
